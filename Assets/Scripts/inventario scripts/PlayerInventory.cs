...
namespace Assets.Scripts
{
    ...
    public sealed class PlayerInventory : MonoBehaviour
    {
        ...
        /// <summary>
        /// Defina a referência singleton e chame Configure
        /// </summary>
        private void Awake()
        {
            if (Instance == null)
        ...
        /// <summary>
        /// Configure a interface do usuário pegando referências e definindo as propriedades necessárias
        /// </summary>
        private async void Configure()
        {
            //Definir referências para mais tarde
            ...
            //Aguarde até que o kit de ferramentas da interface do usuário crie a interface do usuário
